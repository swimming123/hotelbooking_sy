				...
				<div class="col-lg-4 mb-3">
					<div class="testimonial-item mx-auto mb-5 mb-lg-0 circleimage">
						<a href="https://parnashotel.com/reservationSchedule/"><img
							class="img-fluid rounded-circle mb-3"
							src="${rPath }/assets/img/seoul_ninetree.jpg" alt="..." /></a>
						<h5>나인트리 프리미어 호텔</h5>
						<p class="font-weight-light mb-0">***</p>
				...
				<div class="col-lg-4 mb-3">
					<div class="testimonial-item mx-auto mb-5 mb-lg-0 circleimage">
						<a
							...
							src="${rPath }/assets/img/seoul_novotel.jpg" alt="..." />
						</a>
				...
				<div class="col-lg-4 mb-3">
					<div class="testimonial-item mx-auto mb-5 mb-lg-0 circleimage">
						<a href="https://www.busanparadisehotel.co.kr/front/reservation"><img
							class="img-fluid rounded-circle mb-3"
							src="${rPath }/assets/img/busan_paradise.jpg" alt="..." /></a>
						<h5>파라다이스 호텔 부산</h5>
						<p class="font-weight-light mb-0">*****</p>
				...
				<div class="col-lg-4 mb-3">
					<div class="testimonial-item mx-auto mb-5 mb-lg-0 circleimage">
						<a
							...
							class="img-fluid rounded-circle mb-3"
							src="${rPath }/assets/img/busan_shillastay.jpg" alt="..." /></a>
						<h5>신라스테이 해운대</h5>
						<p class="font-weight-light mb-0">****</p>
				...
				<div class="col-lg-4 mb-3">
					<div class="testimonial-item mx-auto mb-5 mb-lg-0 circleimage">
						<a
							...
							class="img-fluid rounded-circle mb-3"
							src="${rPath }/assets/img/busan_signiel.jpg" alt="..." /></a>
						<h5>시그니엘 부산</h5>
						<p class="font-weight-light mb-0">*****</p>
				...
				<div class="col-lg-4 mb-3">
					<div class="testimonial-item mx-auto mb-5 mb-lg-0 circleimage">
						<a href="https://www.shilla.net/jeju/index.do"><img
							class="img-fluid rounded-circle mb-3"
							src="${rPath }/assets/img/jeju_shilla.jpg" alt="..." /></a>
						<h5>제주신라호텔</h5>
						<p class="font-weight-light mb-0">*****</p>
						<p class="font-weight-light mb-0">매우 좋음 9.2</p>
				...
				<div class="col-lg-4 mb-3">
					<div class="testimonial-item mx-auto mb-5 mb-lg-0 circleimage">
						<a
							...
							class="img-fluid rounded-circle mb-3"
							src="${rPath }/assets/img/jeju_ramada.jpg" alt="..." /></a>
						<h5>라마다 프라자 제주</h5>
						<p class="font-weight-light mb-0">****</p>
						<p class="font-weight-light mb-0">좋음 8.2</p>
						<p class="font-weight-light mb-0">제주,대한민국</p>
				...
				<div class="col-lg-4 mb-3">
					<div class="testimonial-item mx-auto mb-5 mb-lg-0 circleimage">
						<a
							...
							class="img-fluid rounded-circle mb-3"
							src="${rPath }/assets/img/jeju_parnas.jpg" alt="..." /></a>
						<h5>파르나스 호텔 제주</h5>
						<p class="font-weight-light mb-0">*****</p>
						<p class="font-weight-light mb-0">매우 좋음 9.4</p>
						<p class="font-weight-light mb-0">제주,대한민국</p>
		...
		<div class="container-fluid p-0">
			...
			<div class="row g-0">
				<div class="col-lg-6 order-lg-2 text-white showcase-img"
					style="background-image: url('${rPath }/assets/img/shilla-showcase.jpg')"></div>
			...
			<div class="row g-0">
				<div class="col-lg-6 text-white showcase-img"
					style="background-image: url('${rPath }/assets/img/ninetree-showcase.jpg')"></div>
			...
			<div class="row g-0">
				<div class="col-lg-6 order-lg-2 text-white showcase-img"
					style="background-image: url('${rPath }/assets/img/newv-showcase.jpg')"></div>
				<div class="col-lg-6 order-lg-1 my-auto showcase-text">
					<h2>HOTEL NEWV</h2>
					<h4>HIDDEN DELIGHT</h4>
					<p class="lead mb-0">
